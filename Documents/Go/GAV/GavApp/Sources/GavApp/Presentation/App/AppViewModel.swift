...
final class AppViewModel: ObservableObject {
    ...
    var settingsService: SettingsServiceAPIProtocol
    ...
    func loadCurrentProfile() async {
        do {
            ...
            applyRemoteProfile(profileModel)
    ...
    private func applyRemoteProfile(_ profileModel: UserProfileModel) {
        let fullName = [profileModel.name, profileModel.surname]
        ...
        profile.handle = username.isEmpty ? profile.handle : "@\(username)"
        profile.bio = profileModel.bio
        profile.avatarURL = MediaURLResolver.resolve(profileModel.profilePhotoUrl)
    }
...
struct MockSettingsServiceAPI: SettingsServiceAPIProtocol {
