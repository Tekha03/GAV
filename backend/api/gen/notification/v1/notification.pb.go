...
const file_notification_notification_proto_rawDesc = "" +
	...
	"\x10SendNotification\x12*.api.social_network.v3.NotificationRequest\x1a+.api.social_network.v3.NotificationResponseB(Z&api/gen/notification/v1;notificationv1b\x06proto3"
