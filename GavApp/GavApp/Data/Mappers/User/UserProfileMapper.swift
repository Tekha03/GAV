...
public struct UserProfileMapper {
    public static func from(model: UserProfileModel) throws -> Domain.UserProfile {
        let locationStatus: Domain.LocationStatus
        ...
        let locationVisibility: Domain.LocationVisibility
    ...
    public static func to(model: Domain.UserProfile) -> UserProfileModel {
